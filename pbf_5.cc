...
static const int FRAME_NUM = 300;
static const int DIM = 3;
static const int NUM_PARTICLES = 13824;
static const int MAX_NUM_PARTICLES_PER_CELL = 100;
static const double TIME_DELTA = 1.0 / 30.0;
...
static const double GRAVITY[DIM] = {0.0, -9.8, 0.0};
